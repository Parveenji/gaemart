...
data class FrameTenModel(
   ...
   * TODO Replace with dynamic value
   */
  var txtIdsoldwaiting: String? =
      MyApp.getInstance().resources.getString(R.string.msg_id_sold_waiting)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtThisprocessca: String? =
      MyApp.getInstance().resources.getString(R.string.msg_this_process_ca4)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtGroupFortyOne: String? =
