package com.parveensapplication.app.modules.frameeleven.`data`.model
...
data class FrameElevenModel(
   ...
   * TODO Replace with dynamic value
   */
  var txtGroup113: String? = MyApp.getInstance().resources.getString(R.string.msg_congratulations2)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtKeepsellingan: String? =
      MyApp.getInstance().resources.getString(R.string.msg_keep_selling_an)
  ,
  /**
   * TODO Replace with dynamic value
   */
