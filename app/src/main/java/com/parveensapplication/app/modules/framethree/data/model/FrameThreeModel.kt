package com.parveensapplication.app.modules.framethree.`data`.model
...
data class FrameThreeModel(
   ...
   * TODO Replace with dynamic value
   */
  var txtLanguage: String? = MyApp.getInstance().resources.getString(R.string.msg_you_haven_t_pl)
  ,
  /**
   * TODO Replace with dynamic value
   */
