...
data class ClashOfClansModel(
   ...
   * TODO Replace with dynamic value
   */
  var txtLanguage: String? = MyApp.getInstance().resources.getString(R.string.lbl_total_gems)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtLanguageOne: String? = MyApp.getInstance().resources.getString(R.string.lbl_total_builder)
  ,
  /**
   * TODO Replace with dynamic value
   */
   ...
   * TODO Replace with dynamic value
   */
  var txtTownHall: String? = MyApp.getInstance().resources.getString(R.string.lbl_town_hall)
  ,
  /**
   * TODO Replace with dynamic value
   */
